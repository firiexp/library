...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"util/modint_base.cpp\"\n\n\n\ntemplate <uint Mod>\nstruct\
    ...
    \ modint& a, const modint& b) { return a.val != b.val; }\n};\n\n\n"
  code: "#ifndef FIRIEXP_LIBRARY_UTIL_MODINT_BASE_CPP\n#define FIRIEXP_LIBRARY_UTIL_MODINT_BASE_CPP\n\
    \ntemplate <uint Mod>\nstruct modint {\n    uint val;\npublic:\n    static modint\
...
layout: document
redirect_from:
- /library/util/modint_base.cpp
- /library/util/modint_base.cpp.html
