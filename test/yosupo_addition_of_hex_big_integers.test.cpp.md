...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_addition_of_hex_big_integers.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/addition_of_hex_big_integers\"\n\n\
    #include <cassert>\n#include <algorithm>\n#include <cstdio>\n#include <cstring>\n\
    #include <string>\n#include <utility>\n#include <type_traits>\n#include <vector>\n\
    ...
    \ * @brief \u591A\u500D\u9577\u6574\u6570(BigInteger)\n */\n#line 15 \"test/yosupo_addition_of_hex_big_integers.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/yosupo_addition_of_hex_big_integers.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo_addition_of_hex_big_integers.test.cpp
- /verify/test/yosupo_addition_of_hex_big_integers.test.cpp.html
