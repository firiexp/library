...
data:
  ...
  bundledCode: "#line 1 \"test/aoj0275_static_bitset.test.cpp\"\n#define PROBLEM \"\
    http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0275\"\n\n#include <algorithm>\n\
    #include <limits>\n#include <queue>\n#include <vector>\nusing namespace std;\n\
    ...
    \ Bitset)\n */\n#line 22 \"test/aoj0275_static_bitset.test.cpp\"\n\nint main()\
    \ {\n    Scanner in;\n    Printer out;\n\n    int n, m;\n    in.read(n, m);\n\
  ...
  verifiedWith: []
documentation_of: test/aoj0275_static_bitset.test.cpp
layout: document
redirect_from:
- /verify/test/aoj0275_static_bitset.test.cpp
- /verify/test/aoj0275_static_bitset.test.cpp.html
