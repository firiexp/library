...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_many_aplusb_diameter_unweighted.test.cpp\"\n\
...
layout: document
redirect_from:
- /verify/test/yosupo_many_aplusb_diameter_unweighted.test.cpp
- /verify/test/yosupo_many_aplusb_diameter_unweighted.test.cpp.html
