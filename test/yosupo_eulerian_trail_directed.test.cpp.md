...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_eulerian_trail_directed.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/eulerian_trail_directed\"\n\n#include\
    \ <algorithm>\n#include <vector>\nusing namespace std;\n\n#include <cstdio>\n\
    #include <cstring>\n#include <string>\n#include <type_traits>\n\n#include <charconv>\n\
    ...
    \ es.end());\n        return {true, vs, es};\n    }\n};\n\n/**\n * @brief \u30AA\
    \u30A4\u30E9\u30FC\u8DEF(Eulerian Trail)\n */\n#line 15 \"test/yosupo_eulerian_trail_directed.test.cpp\"\
    \n\nint main() {\n    Scanner in;\n    Printer out;\n    int t;\n    in.read(t);\n\
    \    while (t--) {\n        int n, m;\n        in.read(n, m);\n        EulerianTrail<true>\
    \ g(n);\n        for (int i = 0; i < m; ++i) {\n            int a, b;\n      \
    \      in.read(a, b);\n            g.add_edge(a, b);\n        }\n        auto\
  ...
  verifiedWith: []
documentation_of: test/yosupo_eulerian_trail_directed.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo_eulerian_trail_directed.test.cpp
- /verify/test/yosupo_eulerian_trail_directed.test.cpp.html
