...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_shift_of_sampling_points_of_polynomial.test.cpp\"\
    ...
    \ conv[k + i] * coef;\n        coef *= c + mint(i + 1);\n        coef *= b[i];\n\
    \    }\n    return res;\n}\n\n/**\n * @brief \u6A19\u672C\u70B9\u30B7\u30D5\u30C8\
    (Sample Point Shift)\n */\n#line 19 \"test/yosupo_shift_of_sampling_points_of_polynomial.test.cpp\"\
    \n\nint main() {\n    Scanner in;\n    Printer out;\n    int n, m, c;\n    in.read(n,\
    \ m, c);\n    vector<mint> ys(n);\n    for (int i = 0; i < n; ++i) {\n       \
    \ int x;\n        in.read(x);\n        ys[i] = x;\n    }\n    vector<mint> ans\
...
layout: document
redirect_from:
- /verify/test/yosupo_shift_of_sampling_points_of_polynomial.test.cpp
- /verify/test/yosupo_shift_of_sampling_points_of_polynomial.test.cpp.html
