...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_enumerate_primes_linear_sieve.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/enumerate_primes\"\n\n#include <limits>\n\
    #include <vector>\nusing namespace std;\n\nusing ll = long long;\ntemplate<class\
    ...
    \ * @brief \u7DDA\u5F62\u7BE9(Linear Sieve)\n */\n\n\n#line 17 \"test/yosupo_enumerate_primes_linear_sieve.test.cpp\"\
    \n\nint main() {\n    Scanner sc;\n    Printer pr;\n\n    int n, a, b;\n    sc.read(n,\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/enumerate_primes\"\n\n\
    #include <limits>\n#include <vector>\nusing namespace std;\n\nusing ll = long\
    \ long;\ntemplate<class T> constexpr T INF = numeric_limits<T>::max() / 32 * 15\
    \ + 208;\n\n#include <cstdio>\n#include <cstring>\n#include <string>\n#include\
  ...
  verifiedWith: []
documentation_of: test/yosupo_enumerate_primes_linear_sieve.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo_enumerate_primes_linear_sieve.test.cpp
- /verify/test/yosupo_enumerate_primes_linear_sieve.test.cpp.html
