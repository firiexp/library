...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_multiplication_of_big_integers.test.cpp\"\n\
    ...
    \ * @brief \u591A\u500D\u9577\u6574\u6570(BigInteger)\n */\n#line 15 \"test/yosupo_multiplication_of_big_integers.test.cpp\"\
    \n\nint main() {\n    Scanner sc;\n    Printer pr;\n    int t;\n    sc.read(t);\n\
    \    while (t--) {\n        BigInteger x, y;\n        sc.read(x, y);\n       \
    \ pr.println(x * y);\n    }\n    return 0;\n}\n"
...
layout: document
redirect_from:
- /verify/test/yosupo_multiplication_of_big_integers.test.cpp
- /verify/test/yosupo_multiplication_of_big_integers.test.cpp.html
