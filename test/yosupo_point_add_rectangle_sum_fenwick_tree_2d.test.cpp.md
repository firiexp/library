...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_point_add_rectangle_sum_fenwick_tree_2d.test.cpp\"\
    ...
    /**\n * @brief 2\u6B21\u5143Fenwick Tree(2D BIT)\n */\n#line 15 \"test/yosupo_point_add_rectangle_sum_fenwick_tree_2d.test.cpp\"\
    \n\nint main() {\n    Scanner sc;\n    Printer pr;\n    int n, q;\n    sc.read(n,\
    \ q);\n\n    struct Operation {\n        int type;\n        int x, y, z, w;\n\
...
layout: document
redirect_from:
- /verify/test/yosupo_point_add_rectangle_sum_fenwick_tree_2d.test.cpp
- /verify/test/yosupo_point_add_rectangle_sum_fenwick_tree_2d.test.cpp.html
