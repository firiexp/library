...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_many_aplusb_binaryindexedtree.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/many_aplusb\"\n\n#include <random>\n\
    ...
    \        }\n        return min(i + 1, n);\n    }\n};\n\n/**\n * @brief Binary\
    \ Indexed Tree(BIT)\n */\n#line 9 \"test/yosupo_many_aplusb_binaryindexedtree.test.cpp\"\
    ...
    \ n - 1)(rng);\n                        int x = uniform_int_distribution<int>(-2,\
    \ 3)(rng);\n                        a[i] += x;\n                        bit.add(i,\
    ...
    \         sum += b[expect];\n                            ++expect;\n         \
    \               }\n                        if (bit_nonneg.lower_bound(x) != expect)\
    \ return 1;\n                    }\n                }\n            }\n       \
    \ }\n    }\n\n    Scanner sc;\n    Printer pr;\n    int t;\n    sc.read(t);\n\
    \    while (t--) {\n        long long a, b;\n        sc.read(a, b);\n        pr.writeln(a\
    \ + b);\n    }\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/yosupo_many_aplusb_binaryindexedtree.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo_many_aplusb_binaryindexedtree.test.cpp
- /verify/test/yosupo_many_aplusb_binaryindexedtree.test.cpp.html
