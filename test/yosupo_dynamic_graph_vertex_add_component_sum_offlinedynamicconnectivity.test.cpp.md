...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_dynamic_graph_vertex_add_component_sum_offlinedynamicconnectivity.test.cpp\"\
    ...
    \ &>) {\n                    f(t, uf);\n                } else {\n           \
    \         f(t);\n                }\n            }\n        );\n    }\n};\n\n/**\n\
    \ * @brief Offline Dynamic Connectivity\n */\n#line 19 \"test/yosupo_dynamic_graph_vertex_add_component_sum_offlinedynamicconnectivity.test.cpp\"\
