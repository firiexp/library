...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_kth_root_integer.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/kth_root_integer\"\n\n#include <cstdio>\n\
    #include <cstring>\n#include <string>\n#include <type_traits>\nusing ull = unsigned\
    ...
    \ Integer)\n */\n#line 12 \"test/yosupo_kth_root_integer.test.cpp\"\n\nint main()\
    \ {\n    Scanner sc;\n    Printer pr;\n    int t;\n    sc.read(t);\n    while\
    \ (t--) {\n        ull a;\n        int k;\n        sc.read(a, k);\n        pr.println(kth_root_integer(a,\
    \ k));\n    }\n    return 0;\n}\n"
...
layout: document
redirect_from:
- /verify/test/yosupo_kth_root_integer.test.cpp
- /verify/test/yosupo_kth_root_integer.test.cpp.html
