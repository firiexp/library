...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_exp_of_formal_power_series.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/exp_of_formal_power_series\"\n\n#include\
    \ <iostream>\n#include <algorithm>\n#include <map>\n#include <set>\n#include <queue>\n\
    #include <stack>\n#include <numeric>\n#include <bitset>\n#include <cmath>\n\n\
    ...
    #line 22 \"test/yosupo_exp_of_formal_power_series.test.cpp\"\n\nint main() {\n\
    \    int n;\n    cin >> n;\n    poly f(n);\n    for (int i = 0; i < n; ++i) {\n\
    \        int x;\n        cin >> x;\n        f[i] = x;\n    }\n    poly g = f.exp(n);\n\
    \    for (int i = 0; i < n; ++i) {\n        if (i) cout << ' ';\n        cout\
    \ << g[i].val;\n    }\n    cout << '\\n';\n    return 0;\n}\n"
  ...
  requiredBy: []
  timestamp: '2026-03-08 14:15:07+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/yosupo_exp_of_formal_power_series.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo_exp_of_formal_power_series.test.cpp
- /verify/test/yosupo_exp_of_formal_power_series.test.cpp.html
