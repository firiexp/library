...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_min_plus_convolution_convex_arbitrary.test.cpp\"\
    ...
    \       } else {\n            ++j;\n        }\n        res[k] = a[i] + b[j];\n\
    \    }\n    return res;\n}\n\n/**\n * @brief min-plus\u7573\u307F\u8FBC\u307F\
    (Min-Plus Convolution)\n */\n#line 8 \"test/yosupo_min_plus_convolution_convex_arbitrary.test.cpp\"\
    \n\nint main() {\n    Scanner sc;\n    Printer pr;\n\n    int n, m;\n    sc.read(n,\
  ...
  verifiedWith: []
documentation_of: test/yosupo_min_plus_convolution_convex_arbitrary.test.cpp
layout: document
redirect_from:
- /verify/test/yosupo_min_plus_convolution_convex_arbitrary.test.cpp
- /verify/test/yosupo_min_plus_convolution_convex_arbitrary.test.cpp.html
