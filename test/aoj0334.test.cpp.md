...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/problems/0334
    links:
  ...
  bundledCode: "#line 1 \"test/aoj0334.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/0334\"\
    ...
    \ match;\n    explicit Bipartite_Matching(int l, int r): l(l), r(r), t(0), G(l+r),\
    \ used(l+r, 0), alive(l+r, -1), match(l+r, -1) {};\n\n    void add_edge(int a,\
    ...
    \ (matching != n) {\n        pr.writeln(\"no\");\n        return 0;\n    }\n \
    \   pr.writeln(\"yes\");\n    for (int i = 0; i < n; ++i) {\n        pr.writeln(G.match[i]\
    \ - n + 1);\n    }\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/problems/0334\"\n\n#include\
