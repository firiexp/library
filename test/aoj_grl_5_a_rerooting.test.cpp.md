...
data:
  ...
  bundledCode: "#line 1 \"test/aoj_grl_5_a_rerooting.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/problems/GRL_5_A\"\n\n#include <algorithm>\n\
    #include <vector>\nusing namespace std;\n\n#include <cstdio>\n#include <cstring>\n\
    ...
    \ ...);\n        pc('\\n');\n    }\n\n    void writeln() {\n        pc('\\n');\n\
    \    }\n};\n\n/**\n * @brief \u9AD8\u901F\u5165\u51FA\u529B(Fast IO)\n */\n#line\
    \ 1 \"tree/rerooting.cpp\"\nusing namespace std;\n\ntemplate <typename M>\nclass\
    \ ReRooting {\npublic:\n    using T = typename M::T;\n    using U = typename M::U;\n\
    \n    struct Node {\n        int to, rev;\n        U val;\n\n        Node(int\
    \ to, int rev, U val) : to(to), rev(rev), val(val) {}\n    };\n\n    int n;\n\
    ...
    \        return ans;\n    }\n};\n\n/**\n * @brief ReRooting(\u5168\u65B9\u4F4D\
    \u6728DP)\n */\n#line 14 \"test/aoj_grl_5_a_rerooting.test.cpp\"\n\nstruct Monoid\
    \ {\n    using T = long long;\n    using U = long long;\n\n    static T f(T a,\
...
layout: document
redirect_from:
- /verify/test/aoj_grl_5_a_rerooting.test.cpp
- /verify/test/aoj_grl_5_a_rerooting.test.cpp.html
