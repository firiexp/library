...
data:
  ...
  bundledCode: "#line 1 \"test/aoj0355.test.cpp\"\n#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0355\"\
    \n#include <iostream>\n#include <algorithm>\n#include <array>\n#include <map>\n\
    #include <set>\n#include <queue>\n#include <stack>\n#include <numeric>\n#include\
    \ <bitset>\n#include <cmath>\n#include <chrono>\n\nstatic const int MOD1 = 1000000861,\
    \ MOD2 = 1000000933;\nusing ll = long long;\nusing uint = unsigned;\nusing ull\
  ...
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=0355\"\
    ...
    \ array<ll, 3>;\n    using L = char;\n    static T f(T a, T b) {\n        return\
    \ {(a[0]*rolling_hash<MOD1>::p()[b[2]]+b[0])%MOD1, (a[1]*rolling_hash<MOD2>::p()[b[2]]+b[1])%MOD2,\
    \ a[2]+b[2]};\n    }\n    static T g(T a, L b) {\n        if(b == l()) return\
    \ a;\n        else {\n            return {hashs1[b-'a'].get(0, a[2]), hashs2[b-'a'].get(0,\
    \ a[2]), a[2]};\n        }\n    }\n    static L h(L a, L b) {\n        if(b ==\
    \ l()) return a; else return b;\n    }\n    static T e() { return {0, 0, 0}; }\n\
