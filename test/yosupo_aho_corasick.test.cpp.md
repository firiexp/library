...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_aho_corasick.test.cpp\"\n#define PROBLEM \"\
    https://judge.yosupo.jp/problem/aho_corasick\"\n\n#include <array>\n#include <string>\n\
    #include <vector>\nusing namespace std;\n\nstatic const int MOD = 998244353;\n\
    using ll = long long;\nusing uint = unsigned;\nusing ull = unsigned long long;\n\
    \n#include <cstdio>\n#include <cstring>\n#include <type_traits>\n\n#line 1 \"\
    util/fastio.cpp\"\nusing namespace std;\n\nextern \"C\" int fileno(FILE *);\n\
    extern \"C\" int isatty(int);\n\ntemplate<class T, class = void>\nstruct is_fastio_range\
    \ : false_type {};\n\ntemplate<class T>\nstruct is_fastio_range<T, void_t<decltype(declval<T\
    \ &>().begin()), decltype(declval<T &>().end())>> : true_type {};\n\ntemplate<class\
    \ T, class = void>\nstruct has_fastio_value : false_type {};\n\ntemplate<class\
    \ T>\nstruct has_fastio_value<T, void_t<decltype(declval<const T &>().value())>>\
    \ : true_type {};\n\ntemplate<class T, class = void>\nstruct has_fastio_assign_string\
    ...
    \ Aho-Corasick\u6CD5\n */\n#line 19 \"test/yosupo_aho_corasick.test.cpp\"\n\n\
    int main() {\n    Scanner sc;\n    Printer pr;\n\n    int n;\n    sc.read(n);\n\
    \    AhoCorasick<26, 'a'> aho;\n    vector<int> parent(1, -1), terminal(n);\n\
    \    for (int i = 0; i < n; ++i) {\n        string s;\n        sc.read(s);\n \
    \       int cur = 0;\n        for (char c : s) {\n            int to = aho.v[cur].to[c\
...
layout: document
redirect_from:
- /verify/test/yosupo_aho_corasick.test.cpp
- /verify/test/yosupo_aho_corasick.test.cpp.html
