...
data:
  ...
  bundledCode: "#line 1 \"test/aoj0439_virtual_tree_helper.test.cpp\"\n#define PROBLEM\
    ...
    \    int stamp = 0;\n\npublic:\n    explicit VirtualTreeHelper(int n) : aux(n),\
    \ mark(n, 0), parent_buf(n, -1) {}\n\n    void add_edge(int u, int v) {\n    \
    ...
    \ _md/virtual_tree_helper.md\n */\n#line 14 \"test/aoj0439_virtual_tree_helper.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/aoj0439_virtual_tree_helper.test.cpp
- /verify/test/aoj0439_virtual_tree_helper.test.cpp.html
