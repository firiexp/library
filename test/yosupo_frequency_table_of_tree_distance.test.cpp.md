...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_frequency_table_of_tree_distance.test.cpp\"\n\
    #define PROBLEM \"https://judge.yosupo.jp/problem/frequency_table_of_tree_distance\"\
    \n\n#include <bits/stdc++.h>\n\nusing namespace std;\n\n#line 10 \"test/yosupo_frequency_table_of_tree_distance.test.cpp\"\
    ...
    \ < (int)res.size(); ++i) {\n            res[i] = internal::combine_u64(c1[i],\
    \ c2[i]);\n        }\n        return res;\n    }\n}\n\n/**\n * @brief \u6574\u6570\
    \u7573\u307F\u8FBC\u307F(2/3 NTT)\n */\n\n\n#line 2 \"tree/frequency_table_of_tree_distance.cpp\"\
    \n\nvector<long long> frequency_table_of_tree_distance(const vector<vector<int>>\
    ...
    \ to, v);\n        }\n        return sz[v];\n    };\n\n    auto find_centroid\
    \ = [&](auto &&self, int v, int p, int half) -> int {\n        for (auto &&to\
    \ : g[v]) {\n            if (to == p || used[to]) continue;\n            if (sz[to]\
    \ > half) return self(self, to, v, half);\n        }\n        return v;\n    };\n\
    \n    auto collect = [&](auto &&self, int v, int p, int d, vector<unsigned int>\
    ...
    \ centroid = find_centroid(find_centroid, start, -1, dfs_size(dfs_size, start,\
    \ -1) / 2);\n        used[centroid] = 1;\n\n        vector<unsigned int> total(1,\
    ...
    \ = ordered[d] / 2;\n    return ans;\n}\n\n/**\n * @brief Frequency Table of Tree\
    \ Distance\n */\n#line 15 \"test/yosupo_frequency_table_of_tree_distance.test.cpp\"\
    \n\nint main() {\n    Scanner sc;\n    Printer pr;\n\n    int n;\n    sc.read(n);\n\
