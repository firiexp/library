...
data:
  ...
  bundledCode: "#line 1 \"test/aoj_alds1_1_c_get_prime2.test.cpp\"\n#define PROBLEM\
    \ \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_1_C\"\n\n#include\
    \ <cstdint>\n#include <vector>\nusing namespace std;\nusing uint = unsigned;\n\
    \n#include <cstdio>\n#include <cstring>\n#include <string>\n#include <type_traits>\n\
    ...
    \ = get_prime_exact_div(32000);\n#line 16 \"test/aoj_alds1_1_c_get_prime2.test.cpp\"\
  ...
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ALDS1_1_C\"\
    ...
    \ \"../math/prime/get_prime2.cpp\"\n\nbool is_prime_number(uint x, const vector<ExactDiv<uint>>\
    \ &primes) {\n    if (x < 2) return false;\n    for (auto &&p : primes) {\n  \
...
layout: document
redirect_from:
- /verify/test/aoj_alds1_1_c_get_prime2.test.cpp
- /verify/test/aoj_alds1_1_c_get_prime2.test.cpp.html
