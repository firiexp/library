...
data:
  ...
  bundledCode: "#line 1 \"test/yosupo_persistent_unionfind_undoableunionfind.test.cpp\"\
    ...
    #include <bits/stdc++.h>\n\nusing namespace std;\n\n#line 10 \"test/yosupo_persistent_unionfind_undoableunionfind.test.cpp\"\
    ...
    \ ...);\n        pc('\\n');\n    }\n\n    void writeln() {\n        pc('\\n');\n\
    \    }\n};\n\n/**\n * @brief \u9AD8\u901F\u5165\u51FA\u529B(Fast IO)\n */\n#line\
    \ 1 \"datastructure/undoableunionfind.cpp\"\nclass UndoableUnionFind {\n    stack<pair<int,\
    \ int>> hist;\n    int forest_size;\n    int snap;\n\npublic:\n    vector<int>\
    \ uni;\n\n    explicit UndoableUnionFind(int sz) : forest_size(sz), snap(0), uni(sz,\
    \ -1) {}\n\n    int root(int a) {\n        if (uni[a] < 0) return a;\n       \
    ...
    \ Undoable Union Find\n */\n#line 14 \"test/yosupo_persistent_unionfind_undoableunionfind.test.cpp\"\
    \n\nint main() {\n    Scanner sc;\n    Printer pr;\n\n    int n, q;\n    sc.read(n,\
